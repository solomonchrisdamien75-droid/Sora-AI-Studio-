...
data class ManhwaTask(
    ...
    val estimatedRemainingSeconds: Int = 45,
    val ramUsageMb: Int = 480,
    val cpuUsagePercent: Int = 35,
    val gpuUsagePercent: Int = 72,
    val currentModel: String = "Manhwa-Composite-Engine-v2",
